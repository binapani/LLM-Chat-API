...
public async Task<IActionResult> IngestDocuments()
{
    var documents = new[]
    {
        ...
        (
            ...
            Content: "Annual leave policy: Full-time employees receive twenty days of annual leave per year. Leave requests should be submitted to a manager at least two weeks in advance."
        ),
        (
